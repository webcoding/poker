...
var nunjucksFilter = require('../filter');


// 在 new 一个 WebLoader 的时候，this(loader).precompiled = window.nunjucksPrecompiled || {}
// 那么即便后面的模板加载好也没用了，所以，还是现在这里设置这个变量，
// 或者改写源代码：this(loader).precompiled = window.nunjucksPrecompiled || (window.nunjucksPrecompiled={})
