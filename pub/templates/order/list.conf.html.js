...
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["templates/order/list.conf.html"] = (function() {function root(env, context, frame, runtime, cb) {
var lineno = null;
var colno = null;
var output = "";
try {
...
return function(ctx, cb) { return nunjucks.render("templates/order/list.conf.html", ctx, cb); }})();


module.exports = function(ctx){
    return nunjucks.render("templates/order/list.conf.html", ctx)
};